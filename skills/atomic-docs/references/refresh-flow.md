...
- `docs-generation-flow.md` for Atomic Docs Goal Gate, domain writer/reviewer subagents, post-write consistency review, and source fact checks after docs are written.
