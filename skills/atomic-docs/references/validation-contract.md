...
- required project goal and conditional glossary shape
...
It does not judge semantic usefulness, source-wide completeness, security, defects, operational timing, or whether the selected update scope was sufficient. Those limits must not be converted into more persistent state.
