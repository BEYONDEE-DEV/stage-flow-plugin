...
- Build one operation-local source evidence index pinned to `source_commit_observed` and reuse it as a navigation seed. Record authoritative anchors for selected context candidates, not every entry point. Reviewers independently recheck changed or risk-bearing claims and sample unchanged high-consequence claims; they do not rediscover every source surface or reread every cited line.
